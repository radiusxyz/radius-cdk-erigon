...
docker cp ./build/bin/cdk-erigon cdk-erigon-sequencer-001--8b14276ed33f460781dc282f89f13847:/usr/local/bin/cdk-erigon \
  && echo "[✔] Successfully copied binary into container"

# 3. Grant execution permission
docker exec -it cdk-erigon-sequencer-001--8b14276ed33f460781dc282f89f13847 chmod +x /usr/local/bin/cdk-erigon \
  && echo "[✔] Granted executable permission to binary"

# 4. Kill existing process
docker exec -it cdk-erigon-sequencer-001--8b14276ed33f460781dc282f89f13847 pkill cdk-erigon \
  && echo "[✔] Terminated existing cdk-erigon process"

# 5. Start new process
docker exec -it cdk-erigon-sequencer-001--8b14276ed33f460781dc282f89f13847 \
