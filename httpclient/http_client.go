...
func makeRequest(ctx context.Context, url string, body any) (*http.Request, error) {
...
func (sc *HttpClient) Send(ctx context.Context, url string, body any, result any) error {
